...
/* harmony import */ var _index_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&lang=scss& */ "../../../workspace/douban/pages/index/index.vue?vue&type=style&index=0&lang=scss&");
...
/***/ "../../../workspace/douban/pages/index/index.vue?vue&type=style&index=0&lang=scss&":
/*!***********************************************************************************!*\
  !*** D:/workspace/douban/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _movieItem = _interopRequireDefault(__webpack_require__(/*! ../../components/movie-item.vue */ "../../../workspace/douban/components/movie-item.vue"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  components: {
    movieItem: _movieItem.default },
  ...
  methods: {
    ...
    // 请求获取正在热映的电影信息
    getHotShowing: function getHotShowing() {var _this = this;
      uni.request({
        ...
        success: function success(res) {
          _this.hotShowingData = res.data.subjects;
        },
    ...
    // 请求top250的电影信息
    getTop250: function getTop250() {var _this2 = this;
      uni.request({
        ...
        success: function success(res) {
          _this2.top250 = res.data.subjects;
    ...
    // 请求即将上映的电影信息
    getComingSoon: function getComingSoon() {var _this3 = this;
      uni.request({
        ...
        success: function success(res) {
          _this3.comingSoon = res.data.subjects;
    ...
    // 请求新片榜的电影信息
    getNewList: function getNewList() {var _this4 = this;
      uni.request({
        ...
        success: function success(res) {
          _this4.newList = res.data.subjects;
    ...
    // 请求本周口碑榜的电影信息
    getPublicPraise: function getPublicPraise() {var _this5 = this;
      uni.request({
        ...
        success: function success(res) {
          ...
          list.map(function (item) {
            _this5.publicPraiseList.push(item.subject);
          });
        },
        fail: function fail(error) {
          console.log(error);
...
var render = function() {
  ...
  return _c("view", { staticClass: "wrapper" }, [
    ...
    _c("view", { staticClass: "sort-list" }, [
      _c(
        "view",
        { attrs: { id: "hot-showing" } },
        [
          _c("movie-item", {
            attrs: {
              movieData: _vm.hotShowingData,
              sort: "影院热映",
              mode: "movie",
              home: true,
              mpcomid: "6c4b56a4-0"
      ...
      _c(
        "view",
        { attrs: { id: "coming-soon" } },
        [
          _c("movie-item", {
            attrs: {
              movieData: _vm.comingSoon,
              sort: "即将上映",
              mode: "movie",
              home: true,
              mpcomid: "6c4b56a4-2"
      ...
      _c(
        "view",
        { attrs: { id: "public-praise-list" } },
        [
          _c("movie-item", {
            attrs: {
              movieData: _vm.publicPraiseList,
              sort: "本周口碑榜",
              mode: "movie",
              home: true,
              mpcomid: "6c4b56a4-4"
